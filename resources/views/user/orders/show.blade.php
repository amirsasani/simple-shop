                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(!$order->transaction_code)
                            <form action="{{ route('orders.update.transactionCode', $order) }}" method="post"
                                  class="mb-4 col-6 mx-auto">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="transaction_code" class="rtl text-right w-100">کد پرداخت:</label>
                                    <input type="number" name="transaction_code" class="form-control"
                                           id="transaction_code">
                                </div>
                                <button class="btn btn-success">ثبت کد پرداخت</button>
                            </form>
                        @endif
